      ...
      <div className="  bg-[url('/src/assets/image2.jpg')]  bg-no-repeat bg-cover h-auto min-h-screen flex items-center  justify-center   ">
        <div className=" text-center flex flex-col justify-center items-center min-h-min ">
          <form
            ...
            action=""
            className="mx-auto text-center mt-5 m-b-5 border-3 p-5 rounded-3xl pb-15 bg-gradient-to-r flex-col justify-center items-center from:gded to-gded2 shadow-lg/70 "
          >
            <h1 className="text-3xl font-bold py-5 text-white text-shadow-lg/50 relative under-line tall-underline   mb-6">
              Join the community{" "}
            </h1>
            <Input
              className="sm:w-90 sm:mb-3 xs:mb-1  text-white xs:w-full "
              classNames={{
            ...
            />
            <Input
              className="sm:w-90 sm:mb-3 xs:mb-1 xs:w-full text-white "
              classNames={{
                label: "text-blue-500 !text-white",
                errorMessage: "text-red-500 font-bold text-md",
              }}
            ...
            />
            <Input
              className="sm:w-90 sm:mb-3 xs:w-full xs:mb-1  text-white"
              classNames={{
                label: "text-blue-500 !text-white",
                errorMessage: "text-red-500 font-bold text-md",
              }}
            ...
            <div className="flex w-full flex-wrap md:flex-nowrap  xs:w-full sm:w-90 ">
              <Select
            ...
            <Button
              type="submit"
              className="mt-4 xs:mt-2 hover:bg-gded3 hover:text-black hover:border-0 font-bold bg-gded2 text-white  shadow-lg/70"
              isLoading={isLoading}
            >
              Submit
            </Button>
